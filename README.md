...
O projeto consiste de um jogo simples de browser de advinhação de números, o código gera um número aleatório entre 1 e 1000 e o jogador tenta advinhar qual o número no menor número de tentativas possível.

É meio que isso, obrigado por ler! :)
...
The project consists of a simple browser game about guessing numbers, the code generates a random number between 1 and 1000 and the player tries to guess what number it is as few tries as possible.
